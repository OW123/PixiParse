...
class IDEApp:
    def __init__(self, root):
        ...
        # Botón para correr el archivo
        self.run_button = tk.Button(self.menu_bar, text="Ejecutar", command=self.run_shell)
        self.menu_bar.add_cascade(label="Ejecutar", menu=self.run_button)
    ...
    def run_shell(self):
        shell_path = os.path.join(os.getcwd(), "shell.py")
        subprocess.run(["start", "cmd", "/k", "python", shell_path])
